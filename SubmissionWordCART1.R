...
MySubmission = data.frame(UniqueID = NewsTest$UniqueID, Probability1 = as.numeric(best.tree.pred > 0.5))

write.csv(MySubmission, "SubmissionWordCART1.csv", row.names=FALSE)
